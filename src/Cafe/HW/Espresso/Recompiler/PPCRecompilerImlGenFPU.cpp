...
bool PPCRecompilerImlGen_FMULS(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	// A * C25 → D (3-op multiply when D may alias A or C)
	ppcImlGenContext->emitInst().make_fpr_r_r_r(PPCREC_IML_OP_FPR_MULTIPLY, fprD, fprA, fprC25);
...
bool PPCRecompilerImlGen_FMADDS(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	DefinePS0(fprD, frD);
	DefineTempFPR(fprC25, 0);
	// Fused A*C25+B via helper (NaN-correct + VE), then round to single.
	// Note: round-to-single of a VE-suppressed prev value is a no-op for the
	// suite's noresult cases (prev is the non-NaN f24 sentinel).
	emit_roundFrC_to25Bit(ppcImlGenContext, fprC25, fprC);
	emit_ppc_fma_call(ppcImlGenContext, (uintptr_t)ppc_fmadd, fprD, fprA, fprC25, fprB);
	PPRecompilerImmGen_roundToSinglePrecision(ppcImlGenContext, fprD);
	PSE_CopyResultToPs1();
	return true;
}
...
bool PPCRecompilerImlGen_FMSUBS(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	DefineTempFPR(fprC25, 0);
	emit_roundFrC_to25Bit(ppcImlGenContext, fprC25, fprC);
	emit_ppc_fma_call(ppcImlGenContext, (uintptr_t)ppc_fmsub, fprD, fprA, fprC25, fprB);
	PPRecompilerImmGen_roundToSinglePrecision(ppcImlGenContext, fprD);
	PSE_CopyResultToPs1();
	return true;
}
...
bool PPCRecompilerImlGen_FNMSUBS(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	DefineTempFPR(fprC25, 0);
	emit_roundFrC_to25Bit(ppcImlGenContext, fprC25, fprC);
	emit_ppc_fma_call(ppcImlGenContext, (uintptr_t)ppc_fnmsub, fprD, fprA, fprC25, fprB);
	PPRecompilerImmGen_roundToSinglePrecision(ppcImlGenContext, fprD);
	PSE_CopyResultToPs1();
	return true;
}
...
bool PPCRecompilerImlGen_FNMADDS(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	DefineTempFPR(fprC25, 0);
	emit_roundFrC_to25Bit(ppcImlGenContext, fprC25, fprC);
	emit_ppc_fma_call(ppcImlGenContext, (uintptr_t)ppc_fnmadd, fprD, fprA, fprC25, fprB);
	PPRecompilerImmGen_roundToSinglePrecision(ppcImlGenContext, fprD);
	PSE_CopyResultToPs1();
	return true;
}
...
bool PPCRecompilerImlGen_PS_MULSX(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode, bool isVariant1)
{
	...
	// Espresso: second multiply factor is 25-bit; both lanes share the same rounded C lane.
	emit_roundFrC_to25Bit(ppcImlGenContext, fprC25, fprC);
	ppcImlGenContext->emitInst().make_fpr_r_r_r(PPCREC_IML_OP_FPR_MULTIPLY, fprDps0, fprAps0, fprC25);
	ppcImlGenContext->emitInst().make_fpr_r_r_r(PPCREC_IML_OP_FPR_MULTIPLY, fprDps1, fprAps1, fprC25);
...
bool PPCRecompilerImlGen_PS_MADDSX(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode, bool isVariant1)
{
	...
	emit_ppc_fma_call(ppcImlGenContext, (uintptr_t)ppc_fmadd, fprDps0, fprAps0, fprC25, fprBps0);
	emit_ppc_fma_call(ppcImlGenContext, (uintptr_t)ppc_fmadd, fprDps1, fprAps1, fprC25, fprBps1);
...
bool PPCRecompilerImlGen_PS_MUL(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	emit_roundFrC_to25Bit(ppcImlGenContext, fprTemp0, fprCps0);
	emit_roundFrC_to25Bit(ppcImlGenContext, fprTemp1, fprCps1);
	ppcImlGenContext->emitInst().make_fpr_r_r_r(PPCREC_IML_OP_FPR_MULTIPLY, fprDps0, fprAps0, fprTemp0);
	ppcImlGenContext->emitInst().make_fpr_r_r_r(PPCREC_IML_OP_FPR_MULTIPLY, fprDps1, fprAps1, fprTemp1);
	PPRecompilerImmGen_roundToSinglePrecision(ppcImlGenContext, fprDps0);
	PPRecompilerImmGen_roundToSinglePrecision(ppcImlGenContext, fprDps1);
	return true;
}
...
bool PPCRecompilerImlGen_PS_MADD(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	emit_ppc_fma_call(ppcImlGenContext, (uintptr_t)ppc_fmadd, fprDps0, fprAps0, fprC25_0, fprBps0);
	emit_ppc_fma_call(ppcImlGenContext, (uintptr_t)ppc_fmadd, fprDps1, fprAps1, fprC25_1, fprBps1);
	PPRecompilerImmGen_roundToSinglePrecision(ppcImlGenContext, fprDps0);
	PPRecompilerImmGen_roundToSinglePrecision(ppcImlGenContext, fprDps1);
	return true;
}
...
bool PPCRecompilerImlGen_PS_NMADD(ppcImlGenContext_t* ppcImlGenContext, uint32 opcode)
{
	...
	emit_roundFrC_to25Bit(ppcImlGenContext, fprC25_0, fprCps0);
	emit_roundFrC_to25Bit(ppcImlGenContext, fprC25_1, fprCps1);
	emit_ppc_fma_call(ppcImlGenContext, (uintptr_t)ppc_fnmadd, fprDps0, fprAps0, fprC25_0, fprBps0);
	emit_ppc_fma_call(ppcImlGenContext, (uintptr_t)ppc_fnmadd, fprDps1, fprAps1, fprC25_1, fprBps1);
	return true;
}
