# Rule: measurement discipline

How to measure this fork without fooling yourself. **Read this before any A/B, telemetry claim,
fps claim, or counter interpretation.** Live numbers and the staged plan still live in
`docs/porting/00-master-plan.md` and `docs/status/`; this file is the trap list and protocol.

`AGENTS.md` points here; do not restate long tables there.
